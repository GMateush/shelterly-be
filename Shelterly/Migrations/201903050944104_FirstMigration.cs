namespace Shelterly.Migrations
{
    ...
    public partial class FirstMigration : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Animals", "ShelterId", "dbo.Shelters");
            DropForeignKey("dbo.Animals", "RaceId", "dbo.Races");
            ...
            DropIndex("dbo.Animals", new[] { "ShelterId" });
            DropIndex("dbo.Animals", new[] { "RaceId" });
